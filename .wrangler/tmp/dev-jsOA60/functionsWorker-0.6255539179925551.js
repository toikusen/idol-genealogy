...
// .wrangler/tmp/pages-bXa8DO/functionsWorker-0.6255539179925551.mjs
...
__name(toVenueEvent, "toVenueEvent");
__name2(toVenueEvent, "toVenueEvent");
function timetreeHeaders(alias) {
  return {
...
__name(timetreeHeaders, "timetreeHeaders");
__name2(timetreeHeaders, "timetreeHeaders");
var onRequest = /* @__PURE__ */ __name2(async ({ request }) => {
  ...
  try {
    ...
    do {
      ...
      cursor = data.paging.next ? data.paging.next_cursor : void 0;
      page++;
...
__name2(isSpaRoute, "isSpaRoute");
var onRequest2 = /* @__PURE__ */ __name2(async ({ request, next, env }) => {
  const url = new URL(request.url);
...
function cacheControlForPath(pathname, status) {
...
__name2(cacheControlForPath, "cacheControlForPath");
var routes = [
  {
...
// node_modules/.pnpm/wrangler@4.93.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@4.93.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-jllUe0/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@4.93.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-jllUe0/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6255539179925551.js.map
